  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <AnimatedSection direction="left" delay={0}>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-primary-medium to-primary rounded-lg mx-auto mb-4 flex items-center justify-center">
            ...
            <AnimatedSection direction="left" delay={200}>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-secondary to-secondary-dark rounded-lg mx-auto mb-4 flex items-center justify-center">
            ...
            <AnimatedSection direction="left" delay={400}>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary-dark rounded-lg mx-auto mb-4 flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <AnimatedSection direction="left">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {/* BPO */}
              <div className="text-center">
                <h3 className="text-xl font-bold mb-4 text-secondary">BPO</h3>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <AnimatedSection direction="left" delay={0}>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="w-16 h-16 bg-gradient-to-br from-secondary to-secondary-dark rounded-lg mb-4 flex items-center justify-center">
            ...
            <AnimatedSection direction="left" delay={0}>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary-dark rounded-lg mb-4 flex items-center justify-center">
      ...
      <section className="bg-gray-900 text-white py-16 px-6 relative overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-secondary opacity-20 rounded-tr-full"></div>
        <div className="absolute bottom-0 right-0 w-32 h-32 bg-secondary opacity-20 rounded-tl-full"></div>
      </section>
    </div>
  );
}